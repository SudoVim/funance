...
class Fund(models.Model):
    ...
    owner = models.ForeignKey('accounts.Account', on_delete=models.CASCADE, related_name='funds')
    ...
    currency = models.CharField(max_length=2, choices=Currency.choices, default=Currency.USD)
